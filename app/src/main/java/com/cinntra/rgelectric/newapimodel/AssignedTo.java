package com.cinntra.rgelectric.newapimodel;
...
public class AssignedTo implements Parcelable
{
    ...
    public final static Creator<AssignedTo> CREATOR = new Creator<AssignedTo>() {
        ...
        public com.cinntra.rgelectric.newapimodel.AssignedTo createFromParcel(android.os.Parcel in) {
            return new com.cinntra.rgelectric.newapimodel.AssignedTo(in);
        }

        public com.cinntra.rgelectric.newapimodel.AssignedTo[] newArray(int size) {
            return (new com.cinntra.rgelectric.newapimodel.AssignedTo[size]);
        }
