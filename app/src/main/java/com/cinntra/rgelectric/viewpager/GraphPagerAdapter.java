package com.cinntra.rgelectric.viewpager;
...
import com.cinntra.rgelectric.activities.MainActivity_B2C;
import com.cinntra.rgelectric.customUI.CustomMarkerView;
import com.cinntra.rgelectric.customUI.CustomMarkerViewReceivables;
import com.cinntra.rgelectric.customUI.RoundedBarChart;
...
public class GraphPagerAdapter extends PagerAdapter {
    ...
    private void managebyShubh(View view, ViewGroup container, List<BarEntry> entries) {
        //todo new setof colors
        int[] colors = new int[]{context.getResources().getColor(R.color.sales_bar_color),context.getResources().getColor(R.color.reciept_bar_color), context.getResources().getColor(R.color.receivables_bar_color)};
        ...
        // dataSet.setColor(context.getResources().getColor(R.color.sales_bar_color));
    ...
    private void managebyShubhReceipt(View view, ViewGroup container, List<BarEntry> entries) {
        ...
        List<IBarDataSet> dataSets = new ArrayList<>();
        BarDataSet dataSet = new BarDataSet(entries, "Values");
      //  dataSet.setColor(context.getResources().getColor(R.color.reciept_bar_color));
        dataSet.setColors(colors);
        dataSet.setDrawValues(false);
        dataSets.add(dataSet);
    ...
    private void managebyShubhReceivable(View view, ViewGroup container, List<BarEntry> entries) {
        ...
        List<IBarDataSet> dataSets = new ArrayList<>();
        BarDataSet dataSet = new BarDataSet(entries, "Values");
      //  dataSet.setColor(context.getResources().getColor(R.color.receivables_bar_color));
        dataSet.setColors(colors);
        dataSet.setDrawValues(false);
        dataSets.add(dataSet);
