...
import com.cinntra.rgelectric.adapters.MessageAdapter;
...
//        callContactApi(opportunityItem.getCardCode());
    ...
    private void showBottomSheet(int id,String name)
    {
        ...
        ReminderSelectionSheet bottomSheetFragment = new ReminderSelectionSheet(id,name, com.cinntra.rgelectric.fragments.LeadFollowUpFragment.this);
