...
import com.cinntra.rgelectric.activities.InvoiceItemList;
...
public class Invoice_Detail_Fragment extends Fragment implements View.OnClickListener {
   ...
   quo_namevalue.setClickable(false);
    ...
    public static com.cinntra.rgelectric.fragments.Invoice_Detail_Fragment newInstance(String param1, String param2)
      {
     com.cinntra.rgelectric.fragments.Invoice_Detail_Fragment fragment = new com.cinntra.rgelectric.fragments.Invoice_Detail_Fragment();
