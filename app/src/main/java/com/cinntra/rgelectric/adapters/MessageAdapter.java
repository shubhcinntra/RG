...
public class MessageAdapter extends RecyclerView.Adapter<com.cinntra.rgelectric.adapters.MessageAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new com.cinntra.rgelectric.adapters.MessageAdapter.ViewHolder(rootView);
    }
