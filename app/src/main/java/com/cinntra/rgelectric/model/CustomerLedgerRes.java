...
public class CustomerLedgerRes implements Serializable
{
    ...
    public List<com.cinntra.rgelectric.model.MonthGroupPurchaseList> getMonthGroupPurchaseList() {
        return MonthGroupPurchaseList;
    }

    public void setMonthGroupPurchaseList(List<com.cinntra.rgelectric.model.MonthGroupPurchaseList> monthGroupPurchaseList) {
    ...
    public List<com.cinntra.rgelectric.model.SalesList> getSalesList() {
        return SalesList;
    }

    public void setSalesList(List<com.cinntra.rgelectric.model.SalesList> salesList) {
        SalesList = salesList;
    }

    public List<com.cinntra.rgelectric.model.ReceiptList> getReceiptList() {
        return ReceiptList;
    }

    public void setReceiptList(List<com.cinntra.rgelectric.model.ReceiptList> receiptList) {
        ReceiptList = receiptList;
    }

    public List<com.cinntra.rgelectric.model.ReceivableList> getReceivableList() {
        return ReceivableList;
    }

    public void setReceivableList(List<com.cinntra.rgelectric.model.ReceivableList> receivableList) {
        ReceivableList = receivableList;
    }

    public List<com.cinntra.rgelectric.model.MonthGroupSalesList> getMonthGroupSalesList() {
        return MonthGroupSalesList;
    }

    public void setMonthGroupSalesList(List<com.cinntra.rgelectric.model.MonthGroupSalesList> monthGroupSalesList) {
    ...
    public void setMonthGroupReceivableList(List<com.cinntra.rgelectric.model.MonthGroupSalesList> monthGroupReceivableList) {
        MonthGroupReceivableList = monthGroupReceivableList;
    }

    public List<com.cinntra.rgelectric.model.MonthGroupSalesList> getMonthGroupReceiptList() {
        return MonthGroupReceiptList;
    }

    public void setMonthGroupReceiptList(List<com.cinntra.rgelectric.model.MonthGroupSalesList> monthGroupReceiptList) {
        MonthGroupReceiptList = monthGroupReceiptList;
    }

    public List<com.cinntra.rgelectric.model.UnderList> getUnderList() {
        return UnderList;
    }

    public void setUnderList(List<com.cinntra.rgelectric.model.UnderList> underList) {
        UnderList = underList;
    }

    public List<com.cinntra.rgelectric.model.UnderList> getOverList() {
        return OverList;
    }

    public void setOverList(List<com.cinntra.rgelectric.model.UnderList> overList) {
        OverList = overList;
    }
